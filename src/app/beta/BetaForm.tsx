  ...
  return (
    <section className="rounded-2xl border border-border bg-surface/50 p-6 sm:p-8">
      ...
      <p className="mb-8 text-muted">
        Fyll ut skjemaet under, så tar vi kontakt når det er din tur.
      </p>
      ...
      {status === "success" ? (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted">
            Vi tar kontakt når det er din tur. Du hører fra oss innen noen dager.
          </p>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <input type="hidden" name="subject" value="Beta testing" />
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={4}
              placeholder="Fortell litt om deg selv og hvorfor du er interessert i å teste Sparlett.no..."
